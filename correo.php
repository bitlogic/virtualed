<?php
    if(isset($_POST['enviar'])){//si el botón con el name enviar es pulsado
        if(!empty($_POST['nombre'])&& !empty($_POST['apellido'])&& !empty($_POST['email'])&& !empty($_POST['telefono'])&& !empty($_POST['institucion'])){
        ...
        //guardo el contenido de cada campo en variables
            ...
            $asunto="[VirtualEd] Has recibido un contacto de [".$nombre." ".$apellido."]";//puedo poner un input asunto o crearlo yo directamente  
            $msg="Nombre: ".$nombre."\r\n";
            $msg.="Apellido: ".$apellido."\r\n";
            $msg.="email: ".$email."\r\n";
            $msg.="telefono: ".$telefono."\r\n";
            $msg.="institucion: ".$institucion."\r\n";
            ...
            $tuCasilla="federico.tanco@bitlogic.io";
